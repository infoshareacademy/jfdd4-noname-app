...
export const DELETE_FAVORITE_STOP_BEGIN = 'favorites/DELETE_FAVORITE_STOP_BEGIN';
export const DELETE_FAVORITE_STOP_END = 'favorites/DELETE_FAVORITE_STOP_END';

export const DELETE_FAVORITE_BUS_BEGIN = 'favorites/DELETE_FAVORITE_BUS_BEGIN';
export const DELETE_FAVORITE_BUS_END = 'favorites/DELETE_FAVORITE_BUS_END';
